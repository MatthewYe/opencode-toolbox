...
If `{outputs_dir}/user_notes.md` exists, read it and include relevant concerns in the grading output.

### Step 6: Critique the Evals

After grading, consider whether the evals themselves could be improved. Only surface suggestions when there's a clear gap.

Good suggestions test meaningful outcomes — assertions hard to satisfy without actually doing the work correctly. Flag things like:
...
- The evidence is superficial — technically satisfied but the underlying task is wrong
