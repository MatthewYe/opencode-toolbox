...
**Important:** The viewer reads field names exactly. Use `configuration` (not `config`), nest `pass_rate` under `result`, etc.
...
See [agents/comparator.md](../agents/comparator.md) for the full schema.
...
See [agents/analyzer.md](../agents/analyzer.md) for the full schema.
